...
@onready var gun_aim_p: Node3D = $"../ScrubPistol/Gun_P/Gun_AIM_P"
#@onready var scrub_gun: Node3D = $"../ScrubGun"
@onready var scrub_gun: BaseGun = scrubroot.gun_component
#@onready var scrub_gun: Node3D = $Visual_MOVE_P/Torso_P/Gun_P/Gun_AIM_P/ScrubGun
@onready var gun_sprite: AnimatedSprite3D = $"../ScrubPistol/Gun_P/Gun_AIM_P/AnimatedSprite3D"
