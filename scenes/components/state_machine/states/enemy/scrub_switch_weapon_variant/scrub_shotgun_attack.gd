...
# SHOTGUN DECREASES ATTACK RANGE AND FLEE RANGE

extends State
class_name ScrubShotgunAttack
...
var shotgun_flee_range_radius: float
var shotgun_attack_range_radius: float
...
func init(blackboard_dict : Dictionary) -> void:
	...
	shotgun_flee_range_radius = blackboard["shotgun_flee_range_radius"]
	shotgun_attack_range_radius = blackboard["shotgun_attack_range_radius"]

func enter() -> void:
	# set collision radius
	#actor.flee_area_3d.get_child(0).shape.radius = shotgun_flee_range_radius
	#actor.att_range_area_3d.get_child(0).shape.radius = shotgun_attack_range_radius
