...
extends "res://art/TechArt/3_CompositorEffects/compositor_effect_base.gd"
...
func _get_shader_path() -> String:
	return "res://art/TechArt/3_CompositorEffects/ChromaticAberration/chromatic_aberration.glsl"
